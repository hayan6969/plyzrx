    ...
    <div className="flex items-center justify-center min-h-screen bg-[url('/img/stars.jpg')] bg-cover bg-center px-4">
      ...
      <div className="space-y-3 font-bodyfont w-full">
        ...
        <div>
          ...
          {errors.fullname && <p className="text-red-500 text-[.9rem]">{"*"+errors.fullname.message}</p>}
        </div>
        ...
        <Button type="submit" className="w-full bg-custompink hover:bg-red-500 h-10 text-base mt-2">
          Sign up
        </Button>
      </div>
    </form>
