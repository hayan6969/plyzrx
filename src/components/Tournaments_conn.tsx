...
<h1 className='leading-4 lg:leading-6 flex flex-col justify-center items-center'> <span
  className=" text-[2.5rem] lg:text-[4.2rem] 2xl:text-[4.8rem] font-headingfont text-white outline-text opacity-50"
  style={{
    color: "transparent",
...
>
  Tournaments
</span> <br /> <span className=' text-[4rem] text-custompink lg:text-[5.5rem] 2xl:text-[6rem] font-dripfont'>Tournaments</span></h1>
